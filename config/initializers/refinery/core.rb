Refinery::Core.configure do |config|
  ...
  config.frontend_refinery_stylesheets_enabled = false
  ...
  # Site name
  config.site_name = "Mini Hotel an der Messe"
  ...
  # config.dragonfly_secret = "5b5c369978b4085fa4ec36d5d2733de7230b8a76dbb28a8d"
